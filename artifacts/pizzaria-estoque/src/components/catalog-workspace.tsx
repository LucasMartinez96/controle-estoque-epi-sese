      ...
      <div className="lg:pl-[250px]">
        <header className="sticky top-0 z-20 border-b border-border/80 bg-background/90 backdrop-blur-xl">
          <div className="flex h-[72px] items-center justify-between gap-3 px-4 sm:px-7 lg:px-10">
            ...
            <div className="flex items-center gap-2"><div className="hidden items-center gap-2 rounded-full bg-accent/10 px-3 py-2 text-xs font-bold text-accent sm:flex"><span className="h-2 w-2 rounded-full bg-accent" /> Sistema online</div><Button variant="soft" className="h-10 min-h-10 px-3" onClick={() => open('product')} data-testid="button-header-add-product"><Plus size={16} /><span className="hidden sm:inline">Novo EPI</span></Button></div>
          </div>
        </header>
